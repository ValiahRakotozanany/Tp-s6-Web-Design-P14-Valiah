    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-6" style="margin-top: 5%;">
                <form>
                    <h1 style="text-align: center;">Insérer journal</h1>
                    <p style="text-align: center;">Code journal</p>
            ...
            <div class="col-md-6" style="margin-top: 5%;">
                <form>
                    <h1 style="text-align: center;margin-top: 0%;">Liste des journaux</h1>
                    <p style="text-align: center;"></p>
                </form>
