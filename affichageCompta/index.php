    ...
    <div class="container">
                ...
                <nav class="navbar navbar-light navbar-expand-md">
                    <div class="container-fluid"><a class="navbar-brand" href="#">Plan Comptable</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                        <div class="collapse navbar-collapse" id="navcol-1">
                            <ul class="navbar-nav">
                                <li class="nav-item"><a class="nav-link" href="exercice.html">Exercice</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Tiers</a></li>
                                <li class="nav-item"><a class="nav-link" href="#">Exporter en pdf</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
        ...
        <div class="row">
            <div class="col-md-6" style="margin-top: 5%;">
                <form>
                    <h1 style="text-align: center;">Insérer compte</h1>
                    <p style="text-align: center;">Numéro de compte</p>
            ...
            <div class="col-md-6" style="margin-top: 5%;">
                <form>
                    <h1 style="text-align: center;margin-top: 11%;">Importer compte</h1>
                    <p style="text-align: center;"><input class="form-control" type="file" style="text-align: center;width: 55%;margin-top: 0%;margin-left: 22%;"></p>
                </form>
                <p style="text-align: center;"><button class="btn btn-primary" type="submit" style="background: rgba(253,71,13,0.84);color: rgb(0,0,0);font-weight: bold;border-style: none;">Insérer</button></p>
            </div>
        </div>
    </div>
